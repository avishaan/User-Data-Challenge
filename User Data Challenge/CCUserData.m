...
+ (NSArray *) users{
  ...
  NSDictionary *user3 = @{USER_NAME: @"iTechnie", USER_EMAIL: @"theRealApple@me.com", USER_PASSWORD: @"infiniteloop", USER_AGE: @30, USER_PROFILE_PICTURE: [UIImage imageNamed:@"person3.jpg"]};
